...
def test_diplotype_assignments():
    ...
    assert dip == '*1/*1'
    assert pheno == 'Normal Metabolizer (NM)'
    ...
    assert dip == '*2/*2'
    assert pheno == 'Poor Metabolizer (PM)'
